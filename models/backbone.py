...
class FrozenMistralBackbone(nn.Module):
    def __init__(self, model_name="mistralai/Mistral-7B-v0.1", peft_path="McGill-NLP/LLM2Vec-Mistral-7B-Instruct-v2-mntp"):
        super(FrozenMistralBackbone, self).__init__()
        ...
        self.l2v.eval()
        print("Backbone loaded successfully. All parameters strictly locked.")
